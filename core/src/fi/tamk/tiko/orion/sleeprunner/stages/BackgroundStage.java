...
public class BackgroundStage extends Stage {
    ...
    private void setupBackgrounds(){
        ...
        addActor(deepLayer);
        midLayer = new MovingBackground(game,game.resources.assetManager.get("graphics/backgrounds/texture_deep_all.png",Texture.class), 1.5f,2);
        addActor(midLayer);
        itemLayer = new MovingBackground(game,game.resources.assetManager.get("graphics/backgrounds/items.png", Texture.class),0.20f,3);
        addActor(itemLayer);
    ...
    public void increaseSpeed(){
        ...
        if(itemLayer.getSpeed()>0.1f) {
            itemLayer.setSpeed(itemLayer.getSpeed() - 0.05f);
        }
